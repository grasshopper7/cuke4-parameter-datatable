Feature: DataTable Conversion for Cucumber-JVM 4
  ...
  Scenario: DataTable scenario List<List<String>>
    Given the list string lecture details are
      | Jane | 40 | Assistant |
      | Doe  | 30 | Associate |

  Scenario: DataTable scenario primitive List<LecturePrimitive>
  ...
  Scenario: DataTable scenario List<Lecture>
  ...
  #Scenario: DataTable scenario List<LectureLite>
  ...
  Scenario: DataTable scenario Map<String, Lecture>
  ...
  Scenario: DataTable scenario Map<Lectureid, Lecture>
  ...
  #Scenario: DataTable scenario Lectures
